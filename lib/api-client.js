...
export function gatewayRequest(method, path, session, endpoint, body = null, params = {}) {
  return requestWithRefresh(method, path, session, endpoint, body, params).response;
}
...
export function gatewayJsonRequest(
  ...
  return checkJsonResponse(response, requestName, expectedStatus, structureCheck, context);
}
